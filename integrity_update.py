...
def update_integrity(html_path, base_dir=None, inplace=False, output=None):
    if base_dir is None:
...
if __name__ == '__main__':
    ...
    update_integrity(args.html, base_dir=args.base_dir, inplace=args.inplace, output=args.output)
